...
Log(Application de Migration)
    ...
    Passons a l'implementation des features demandés au jour 3 
    a cette fait j'ai basculer sur une branch day3 pour bien dissocier et 
    ressortir l'evolution de notre projet 
    Tu trouveras ce qui a ete demande de rajouter pour je trois dans le fichier 
    evaluation_jour3.md

    Ok tous semble fonctionner tres bien mais pour l'envoie de message privé, j ai beau entrer dans le profil d'un utilisateur je trouve toujour pas le moyen de l'envoyer un message privé ! 
    essaye de verifier cette aspect 
    important : 
        j espere l'envoie d un message declenche une notification chez le recepteur du message 

    Ok progressons utilise  une couleur differentes pour dissocier les message du destinataire de celui destinataire, faisons comme dans les application de message, les message du destinateur et celui du  destinataire ne sont pas du meme coté 


    Je pense que t' es resolu le probleme de background de color utiliser pour le